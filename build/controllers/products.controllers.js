...
var updateProductById = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var productId, _req$body2, name, price, category, imgURL, product;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            productId = req.params.productId;
            _req$body2 = req.body, name = _req$body2.name, price = _req$body2.price, category = _req$body2.category, imgURL = _req$body2.imgURL;
            _context4.next = 5;
            return _Product.Product.findByPk(productId);
