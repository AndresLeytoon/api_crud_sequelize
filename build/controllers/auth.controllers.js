...
var singUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var passBcrypt, _req$body, username, email, newUser, savedUser, tokek;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            passBcrypt = _bcryptjs["default"].hashSync(req.body.password, 10);
            _req$body = req.body, username = _req$body.username, email = _req$body.email;
            newUser = new _User.Users({
              username: username,
              email: email,
              password: passBcrypt
            });
          ...
          case 5:
            ...
            tokek = _jsonwebtoken["default"].sign({
              id: savedUser.id
